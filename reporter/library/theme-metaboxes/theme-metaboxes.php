	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array( 
				...
				'desc' => __('Select a position for the sidebar or simply remove it.','engine'),
				'id' => $prefix . 'sidebar_pos',
				'type' => 'select',
				'std' => $post_sidebar_pos,
				'options' => array( 
					array('value' => 'right', 'name' => __('Right','engine') ),
					array('value' => 'left', 'name' => __('Left','engine') ),
					array('value' => 'none', 'name' => __('No Sidebar','engine') )
				)
			)
		)
